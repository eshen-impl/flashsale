...
public class FlashSaleOrderController {
    ...
    public ResponseEntity<FlashSaleOrderNotification> submitOrder(@PathVariable("id") Long id, @RequestHeader("X-User-Id") String userIdString) {
        UUID userId = UUID.fromString(userIdString);
        return ResponseEntity.ok(flashSaleOrderService.submitOrder(id, userId));
    }
